function sendEmails() {
  ...
  for (var i = 0; i < data.length; i++) {
    ...
    var custom = row[3];
    {
      ...
      var body = "Hey " + firstName + "," + '\n\n' + "I don't know if this is your kind of thing, but my journalism/tech group is having an event the week after next: https://www.meetup.com/Hacks-Hackers-New-Orleans/events/251442786/ \n\nI'll be teaching how to do data visualization with some free Google tools like Fusion Tables and Flourish. We'll have pizza and beer. Would love to see you there!"; 
